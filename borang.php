...
<h2 class="text-center mb-4">Borang Maklumat Pelajar</h2>
<form action="proses.php" method="POST">
<div class="row border p-4">

<!-- Nama -->
<div class="col-md-4 mb-3 border p-3"><label class="form-label">Nama Pelajar</label>
<input type="text" 
name="nama" 
class="form-control">
<p class="text-danger">
...
<br>
<input type="radio" name="jantina"value="Lelaki">
Lelaki
<input type="radio" name="jantina"value="Perempuan"class="ms-3">
Perempuan
<p class="text-danger">
<?= $err_jantina ?>
</p>
...
<option value="Diploma Kejuruteraan">Diploma Kejuruteraan
</option>
